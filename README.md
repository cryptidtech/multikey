...
A Rust implementation of the [multiformats][2] [multikey specification][3].
...
[`ssh-key`][4] crate. This gives full OpenSSH compatibility for reading in
...
keys through the use of [RFC 4251][5] standard for "additional algorithms"
...
creating and verifying [`Multisig`][4] digital signatures.
...
[4]: https://github.com/cryptidtech/multisig
